...
if __name__ == '__main__':
    ...
    meta_agent.initilise_memory(augment_data=True, augment_rewards=True, augment_noise_ratio=0.1)

    meta_agent.initilise_agents()

    meta_agent.train(episodes=episodes, summary_writer_name=f'meta_agent_a_{batch_size}')
